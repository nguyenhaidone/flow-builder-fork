...
// import { getRegisterNode } from 'react-flow-builder/dist/utils';
...
const NodeDisplay: React.FC = () => {
  ...
  // const registerNode = getRegisterNode(registerNodes, exampleNode.type);
...
const Display = () => {
  ...
  function recursion(defaultData) {
                        ...
                        children: [
                          {
                            ...
                            children: [
                              {
                                id:
                                  "condition-e1490142-829c-460a-8889-73318464788f",
                                type: "condition",
                                name: "Condition node",
                                children: [],
                                path: [
                              ...
                              {
                                id:
                                  "condition-b08a8744-979f-4229-80d9-b898f8cf7023",
                                type: "condition",
                                name: "Condition node",
                                children: [],
                                path: [
